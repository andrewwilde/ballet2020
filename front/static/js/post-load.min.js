		...
		$.each(classes, function(idx, dance_class) {
			...
			if (dance_class['dance_type'] == 'Dance'){
				...
				var class_template = `	<div class="ci-metas">
								<div class="ci-meta" style="margin-bottom:0px;"><h6>${start_day} to ${end_day} @ ${start_time} - ${stop_time} ${class_status}</h6></div>
								<br/>
								<div class="ci-meta"><h6 style="font-size:12px">${description}</h6></div>
							</div>`
