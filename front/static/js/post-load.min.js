		...
		$.each(classes, function(idx, dance_class) {
			...
			if (dance_class['dance_type'] == 'Dance Camp'){
				...
				var class_template = `	<div class="ci-metas">
								<div class="ci-meta" style="margin-bottom:0px;"><h6>${day}</h6><h6>${start_day} to ${end_day} @ ${start_time} - ${stop_time} ${class_status}</h6><h6 style="font-size:12px">${description}</h6></div>
								<br/><br/>
							</div>`
