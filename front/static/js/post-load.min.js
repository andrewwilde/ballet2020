...
<div class="classes-item">
	...
	<div class="ci-text">
		...
		<h6 style="margin-bottom:15px">${sale_price && sale_price !== 0 && sale_price !== "" ? `<span class="sale-price">$${sale_price}</span> <span class="original-price">$${price}</span>` : `$${price}`} ${payment_frequency}</h6>
		${date_range}
		${times}
	</div>
	<div class="ci-bottom">
